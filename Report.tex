...
โครงงานนี้เป็นโครงงานที่เกี่ยวกับการสร้างเว็บแอปพลิเคชันสำหรับการออกแบบภายในให้กับห้องนอนหรือห้องน้ำ เพื่อใช้เป็นแหล่งค้นหาไอเดียให้กับ
ผู้ที่ต้องการออกแบบภายในให้กับห้องนอนหรือห้องน้ำ โดยการนำ Stable Diffusion ซึ่งเป็น Generetive AI มาใช้เป็นเครื่องมือ
ในการสร้างรูปภาพ โดยผู้ใช้สามารถเลือกรูปแบบของห้อง ชนิดของห้องที่ต้องการ เฟอร์นิเจอร์ที่ต้องการให้อยู่ภายในรูปภาพ
โดยเมื่อ Stable Diffusion สร้างรูปภาพขึ้นมาแล้ว ผู้ใช้สามารถทราบราคาเฉลี่ยของเฟอร์นิเจอร์ที่อยู่ในรูปภาพนั้นรวมไปถึง
แหล่งจัดจำหน่ายเฟอร์นิเจอร์ดังกล่าว
...
\begin{table}[!h]
  \caption{data dictionary ของ account }\label{tbl:er-table1}
  \begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|}
    \hline
    \textbf{ชื่อของ field} & \textbf{รูปแบบข้อมูล} & \textbf{คำอธิบาย}                               \\
    \hline
    id                   & ObjectId           & รหัสประจำตัวของ account                          \\
    \hline
    email                & String             & อีเมลล์                                         \\
    \hline
    password\_hash       & String             & รหัสผ่านที่ผ่านการ hash ด้วย Argon 2 hash algorithm \\
    \hline
    firstname            & String             & ชื่อจริง                                         \\
    \hline
    lastname             & String             & นามสกุล                                        \\
    \hline
    date\_of\_birth      & Date               & วันเดือนปีเกิด YYYY-MM-DD                         \\
    \hline
    sex                  & String             & เพศมีทั้งหมด 3 เพศคือ male female และ others      \\
    \hline
    role                 & String             & ตำแหน่งซึ่งจะมีทั้งหมด 2 ตำแหน่งคือ user และ admin      \\
    \hline
  \end{tabular}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|}
    ...
    \textbf{ชื่อของ field} & \textbf{รูปแบบข้อมูล} & \textbf{คำอธิบาย}                                                                                                                                                                              \\
    \hline
    id                   & ObjectId           & รหัสประจำตัวของ result                                                                                                                                                                          \\
    \hline
    owner\_id            & ObjectId           & รหัสประจำตัวของผู้ใช้ที่สร้างresultซึ่งอ้างอิงได้จาก account                                                                                                                                               \\
    \hline
    room\_id             & ObjectId           & รหัสประจำตัวของห้องและสไตล์ที่เลือกใช้เพื่อสร้างresultซึ่งสามารถอ้างอิงได้จาก room                                                                                                                            \\
    \hline
    status               & String             & สถานะของผลลัพธ์                                                                                                                                                                                \\
    \hline
    furniture\_list      & [ObjectId]         & รหัสประจำตัวของเฟอร์นิเจอร์ที่ใช้ในการสร้างresultซึ่งสามารถอ้างอิงได้จาก furniture                                                                                                                          \\
    \hline
    task                 & String             & ลักษณะของงานที่เลือกในการสร้างresult                                                                                                                                                              \\
    \hline
    budget               & float              & ราคาที่ผู้ใช้ตั้งไว้ในการสร้างresult                                                                                                                                                                  \\
    \hline
    image                & Object             & รูปภาพที่ได้จากการทำงาน ของ Ai service ซึ่งจะเก็บเป็น object โดยจะมี Index ไว้บ่งบอกว่าเป็นรูปที่เท่าไหร่ และ url ที่เก็บลิงก์ของรูปภาพหลังจากฝากไว้ที่ cloudinary                                                        \\
    \hline
    post                 & Object             & ข้อมูลรายละเอียดต่างๆของโพสต์ที่เกี่ยวข้องกับ result โดยจะมี post\_id เป็นรหัสประจำตัวของโพสต์  title เป็นหัวข้อของโพสต์ description  เป็นเนื้อหาในโพสต์ status คือสถานะของ โพสต์ซึ่งมี 2 แบบคือ deleted และ active privacy
...
\begin{table}
  \caption{data dictionary ของ session\_management }\label{tbl:er-table3}
  \begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|}
    \hline
    \textbf{ชื่อของ field} & \textbf{รูปแบบข้อมูล} & \textbf{คำอธิบาย}                                             \\
    \hline
    id                   & ObjectId           & รหัสประจำตัวของ session                                        \\
    \hline
    refresh\_token       & String             & เก็บ JWT refresh\_token ของผู้ใช้                               \\
    \hline
    expire\_date         & Date               & เวลาที่ refresh\_token หมดอายุ                                 \\
    \hline
    owner\_id            & String             & รหัสประจำตัวของเจ้าของ refresh\_token ดังกล่าว ซึ่งอ้างอิงจาก account \\
    \hline
  \end{tabular}
\end{table}
\begin{table}
...
\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/frontend-1.png}
  \caption{แสดงหน้า About Us ซึ่งประกอบข้อมูลของเว็ปไซต์และคณะผู้จัดทำ}
