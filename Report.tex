...
ิ\begin{enumerate}
\item Download รูปภาพจากเว็บไซต์ www.pinterest.com โดยใช้เครื่องมือช่วย Download
โดยมีข้อมูลดังนี้
\begin{itemize}
\item ประเภทของห้อง
\begin{enumerate}
...
หลังจากได้รูปภาพมาแล้ว นำไปทำการ resize ด้วยเว็บไซต์ https://www.birme.net เพื่อทำการ resize ให้เป็นขนาด 512x512 pixel
และตั้งชื่อใหม่ให้กับรูปภาพทั้งหมด
\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/prepare-data-1.jpg}
  \caption{resize รูปภาพให้เป็นขนาด 512x512 pixel บนเว็บไซต์ https://www.birme.net}
...
\begin{figure}[!h]\centering
\includegraphics[width=10cm]{image/prepare-data-5.jpg}
...
\begin{figure}[!h]\centering
  ...
  \caption{ตัวอย่างผลลัพธ์ที���ได้จากโมเดล}
...
พัฒนาระบบที่ช่วยอํานวยความสะดวกเกี่���วกับการออกแบบภายใน โดยเราจะนําข้อมูลนั้นไปใช้ในการสร้างเü็บไซต์แอปพลิเคชันที่สามารถ
ใช้งาน AI ในการสร้างรูปของห้องต่างๆและสามารถประเมินค่าใช้จ่ายทั้งหมดจากภาพที่ AI สร้างขึ้น ซึ่งข้อมูลที่ได้รับจะไม่ถูกนําไปเปิดเผย
