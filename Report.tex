...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\preface
ขอบคุณอาจารย์ที่ปรึกษา กรรมการ มหาวิทยาลัยเทคโน��ลยีพระจอมเกล้าธนบุรี ที่ให้โอกาสในการทำโครงงานนี้ขึ้นมา และเพื่อนๆกับครอบครัวที่อยู่เคียงข้าง ช่วยเหลือให้งานนั้นสำเร็จตามต้องการ
...
\begin{enumerate}
  \item ไม่สามารถอัปโหลดผลิตภัณฑ์ของผู้ใช้งานขึ้นเว็บแอบพลิเคชันได้ในกรณีที่ผู้ใช้งานมีความต้องการที่	จะให้ผลิตภัณฑ์ของตนอยู่ในแบบที่โมเดลออกแบบ(นอกเหนือจาก��านข้อมูลที่มี)
...
\begin{figure}[!h]\centering
  ...
  \caption{แสดงถึงแผนภูมิแกนต์ในการวางแผนงานในภ��คเรียนที่ 2}
  \label{fig:gantt-chart}
\end{figure}
...
\begin{itemize}
  ...
  \item \textbf {Variational Autoencoder (VAE)}
        เป็น Convolutional Neural Network ที่ใช้ในการบีบอัด Dimensions ของข้อมูลลงเพื่อให้มีขนาดของข้อมูลที่เล็กลง สามารถลดลงไปได้ถึง 48 เท่าของขน���ด���าพ���ดิม VAE ประกอบไปด้วย 2 ส่วนได้แก่
...
\hspace {18pt} Zero-shot \cite{zeroshot} เป็นเทคนิคการใช้งานโมเดลที่ผ่านการ training มาแล้วด้วยชุดข้อมูล Domain หนึ่ง และนำมาใช้ในการทำ��ายในอีกชุดข้อมูลที่ Domain ไม่ได้ผ่านการเรียนรู้มาก่อน
...
\begin{enumerate}
  ...
  \item การ Generate รูปภาพจากข้อความ (text to image)
        \par \hspace {18pt} เว็ปแอปพลิเคชัน Spacely AI สามารถสร้างรูปภาพข้อความโดยจะรับอินพุตเป็นข้อควา��ซึ่งจะได้ผลลัพธ์เป็นรูปภาพ 4 ภาพทีแตกต่างกันหากต้องการที่จะทราบรายละเอียดเฟอร์นิเจอร์ที่ใช้จะต้องโหลดรูปภาพและนำไปใช้งานกับฟีเจอร์ตรวจจับเฟอร์นิเจอร์ มีตัวอย่างดังนี้
        \par
...
\begin{enumerate}
  ...
  \item \textbf{Python} เป็นภาษาโปรแกรมมิ่งระดับสูงที่มีความเข้าใจง่ายและมีความหลากหลายในการใช้งาน มันเป็นภาษาที่มีการเรียนรู้และการใช้���านที่สะดวก ทำให้เป็นที่นิยมอย่างมากในหลายสายงานและอุตสาหกรรมต่าง ๆ รวมถึงเป็นภาษาหลักที่ใช้ในงานด้าน Data Science และ Machine Learning
...
\begin{enumerate}
  ...
  \item \textbf{Kohya}เป็น GUI (Graphical user interface) สำหรับ Train Model ให้กับ Stable Diffusion ซึ่ง UI จะใช��ตั้งค่าพารามิเตอร์ในการ Train และรันคำสั่ง CLI (Command-line user interface) สำหรับการฝึกโมเดล
...
\begin{table}[!h]
  ...
  \begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|}
    ...
    \hline
    firstname            & String             & ชื่อจริงภาษาอัง��ฤษ                                     \\
    \hline
...
\begin{enumerate}
  ...
  \item ขนาดของรูปภาพจะต้องมีขนาดมากกว่า 512x512 pixel
...
\subsection{ข้อมูลเพื่อใช้ในการ train โมเดล}
...
% \begin{figure}
%   \includegraphics[width=10cm]{image/prepare-data-3.jpg}
%   \caption{ใช้ BLIP บน Kohya UI ในการสร้างคำอธิบายให้กับรูปภาพ}
%   \label{fig:prepare-data-3}
% \end{figure}
...
\subsubsection{โมเดลรูปแบบปละประเภทของห้อง}
...
\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/modern_bedroom.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:modern_bedroom}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/modern_bathroom.png}
  \caption{ตัวอย่างผลลัพ���์���ี่ได้จากโมเดล}
  \label{fig:modern_bathroom}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/contemporary_bedroom.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:contemporary_bedroom}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/contemporary_bathroom.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:contemporary_bathroom}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/bohemian_bedroom.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:bohemian_bedroom}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/bohemian_bathroom.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:bohemian_bathroom}
\end{figure}
...
\subsubsection{โมเดลรูปแบบปละประเภทของเฟอร์นิเจอร์}
...
\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/TVARHAND.jpg}
  \caption{ตัวอย่างของโคมไฟรุ่น TVARHAND จาก IKEA}
  \label{fig:TVARHAND}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/TARVA.jpg}
  \caption{ตัวอย่างเตียง TARVA จาก IKEA}
  \label{fig:TARVA}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/result-furniture-1.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:result-furniture-1}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/result-furniture-2.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:result-furniture-2}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/result-furniture-3.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:result-furniture-3}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/result-furniture-4.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:result-furniture-4}
\end{figure}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{image/result-furniture-5.png}
  \caption{ตัวอย่างผลลัพธ์ที่ได้จากโมเดล}
  \label{fig:result-furniture-5}
\end{figure}
...
ช่วยชูกูล นักศึกษาชั้นปีที่ 4 ภาควิชาวิศวกรรมคอ��พิวเตอร์ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี
...
พัฒนาระบบที่ช่วยอํานวยความสะดวกเกี่���วกับ��ารออกแบบภายใน โดยเราจะนําข้อมูลนั้นไปใช้ในการสร้างเü็บไซต์แอปพลิเคชันที่สามารถ
ใช้งาน AI ในการสร้างรูปของห้องต่า���ๆแ����สามารถประเม��นค่����ช้จ่ายทั�����หมดจากภ���พที่ AI ����ร���างขึ้น ซึ่งข้อมูลที่ได้รับจะไม่ถูกนําไปเปิดเผย
และใช้เพื่อกา��ศีกษาเท่านั้�����

\hspace {18pt} สา���ารถเข้าทำแบบสอบถามได้จาก \url{https://forms.gle/jPAt6VJqqN2smsn29}
