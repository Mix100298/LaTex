...
\begin{figure}[!h]\centering
  \includegraphics{image/new-ER.png}
  \caption{ER Diagram}
  \label{fig:er}
\end{figure}

\hspace {18pt} จากภาพ~\ref{fig:er} สามารถบ่งบอกได้ว่าโครงสร้างของ Database ของเว็บแอปพลิเคชัน Easy Room มีทั้งหมด 5 collections คือ 1.account 2.result 3.like 4.room และ 5.furniture ซึ่ง account จะมีหน้าที่ในการเก็บข้อมูลของผู้ใช้ โดยจะมี data dictionary ดังนี้
...
\begin{table}[!h]
  ...
  \begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|}
    ...
    \hline
    id                   & ObjectId           & ID ของ account                          \\
    \hline
    email                & String             & อีเมลล์                                         \\
    \hline
    password       & String             & รหัสผ่านที่ผ่านการ hash ด้วย Argon 2 hash algorithm \\
    \hline
    firstname            & String             & ชื่อจริง                                         \\
    \hline
    lastname             & String             & นามสกุล                                        \\
    \hline
    date\_of\_birth      & Date               & วันเดือนปีเกิด                          \\
    \hline
    sex                  & String             & เพศมีทั้งหมด 3 เพศคือ male female และ others      \\
    \hline
    role                 & String             & ตำแหน่งซึ่งจะมีทั้งหมด 2 ตำแหน่งคือ User และ Admin      \\
    \hline
    avatar_image&String&ลิงก์ของรูปโปรไฟล์ที่ได้จากการฝากรูปจาก cloudinary
    \hline
    create\_at&Date&เวลาที่บัญชีนี้ถูกสร้างขึ้น
    \hline
    update\_at&Date&เวลาที่มีการแก้ไขล่าสุด
  \end{tabular}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|}
    ...
    \textbf{ชื่อของ field} & \textbf{รูปแบบข้อมูล} & \textbf{คำอธิบาย}                                                                                                                                                                              \\
    \hline
    id                   & ObjectId           & ID ของ การ Generate รูปภาพ                                                                                                                                                                          \\
    \hline
    owner\_id            & ObjectId           & ID ของผู้ใช้ที่สร้าง result                                                                                                                                        \\
    \hline
    ...
    \hline
    image                & Object             & รูปภาพที่ได้จากการgenerate รูปภาพ ซึ่งจะเก็บเป็น object โดยจะมี Index ซึ่งบ่งบอกว่าเป็นรูปที่เท่าไหร่ และ url คือลิงก์ที่ได้จากการเก็บรูปภาพที่ cloudinary                                                        \\
    \hline
