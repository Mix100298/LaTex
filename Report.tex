...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\preface
ขอบคุณอาจารย์ที่ปรึกษา คณะกรรมการ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี ที่ให้โอกาสในการทำโครงงานนี้ขึ้นมา และเพื่อนๆกับครอบครัวที่อยู่เคียงข้าง ช่วยเหลือให้งานนั้นสำเร็จตามต้องการ
...
\begin{enumerate}
  ...
  \item Admin สามารถเพิ่มเฟอร์นิเจอร์และรายละเอียดเพื่อเก็บข้อมูลไปใช้ในการพัฒนาความรู้ให้กับ
        Stable Diffusion
...
\begin{itemize}
  ...
  \item โมเดลมีประสิทธิภาพในการ Generate รูปภาพที่สมเหตุสมผลตามเงื่อนไขที่ผู้ใช้งานระบุ
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf {Variational Autoencoder (VAE)}
        ...
        Stable Diffusion Model จะทำการ Encode รูปภาพก่อนที่จะสู่กระบวนการทำ Forward Diffusion และหลังจากจบกระบวนการ Reverse Diffusion จะทำการ Decode Latent Vector ให้กลับมาเป็นรูปภาพปกต��� ดังภาพ ~\ref{fig:autoencoder}
...
\hspace {18pt}ผู้ใช้ที่มีความต้องการเครื่องมืออำนวยความสะดวกในเรื่องของการออกแบบภายในและต้องการทราบราคาที่ใช้ในการก่อสร้างรวมไปถึงรายละเอียดสิงของต่างๆ อาทิเช่น ราคา สถานที่จำหน่าย เพื่อเพิ่มความสะดวกสบายในการค้นหาสินค้าตกแต่งบ้าน โดย Guest สามารถที่จะ Login และ Register Customer สามารถที่จะใช้ AI ในการ Generate รูปภาพ ดูรูปภาพที่ตนให้ AI สร้าง สามารถดูประวัติการใช้งานของตน สามารถอัปโหลดรูปภาพให้ AI ในการค้นหาผลิตภัณฑ์ที่มีในเว็บไซต์ และ Admin สามารถทำทุกอย่างที่ Customer ทำได้ทั้งหมด และสิ่งที่ทำได้เพิ่มเติมดังนี้ สามารถดูข้อมูลการใช้เฟอร์นิเจอร์ของ AI ในการ Generate รูปภาพ อัตราการใช้แต่ละสไตล์แต่ละชนิดของห้องของผู้ใช้งานซึ่งจะอยู่ในรูปแบบของ Dashboard และสามารถเพิ่มผลิตภัณฑ์และเฟอร์นิเจอร์ได้ ดังภาพ~\ref{fig:use-case}
...
จากที่ได้กล่าวถึงว่า ผลลัพธ์ที่ได้จากโมเดลนั้นไม่สามารถวัดผลได้ด้วยค่า f1-score, precision และ recall ทำให้คณะผู้จัดทำพิจารณาให้การทดสอบโมเดลจะเป็นการทำแบบสอบถามในเรื่องความพึงพอใจกับผลลัพธ์ของโมเดล
\subsection{การทดสอบเว็บแอปพลิเคชัน}
สำหรับการทดสอบเว็บแอปพลิเคชัน ทางคณะผู้จัดทำทดสอบตาม flow ของ use-case scenario 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Ref %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makeatletter
